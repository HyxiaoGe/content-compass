...
const mockDetailData: Record<string, ContentCard[]> = {
  ...
  'claude': [
    ...
    },
    {
      ...
      title: 'Claude 3.5 Sonnet与Artifacts创作工具发布',
      summary: 'Anthropic发布Claude 3.5 Sonnet，在编程、写作和分析任务上显著提升。同时推出Artifacts功能，支持实时代码预览、交互式图表和可编辑内容创建。Projects功能为团队协作提供知识管理和对话组织工具，大幅提升工作效率。',
      keyPoints: [
        'Claude 3.5 Sonnet：编程和分析能力大幅提升',
        'Artifacts实时预览：SVG图形、网站和计算器等交互内容',
        'Projects团队协作：Pro和Team用户的知识管理工具',
        '隐私保护承诺：用户数据不用于模型训练',
        '多平台支持：API、AWS Bedrock、Google Cloud可用',
        '成本效益优化：相比前代模型显著降低使用成本'
      ],
      importance: 'high',
      publishedAt: '2024-06-25T14:00:00Z',
      originalUrl: 'https://www.anthropic.com/news/claude-3-5-sonnet',
      tags: ['claude-3.5', 'artifacts', 'projects', 'team-collaboration']
    },
    {
      id: '2-prev2',
      product: {
      ...
      title: 'Claude 3系列模型发布 - Haiku、Sonnet、Opus',
      summary: 'Anthropic发布Claude 3系列，包括轻量级Haiku、平衡版Sonnet和旗舰级Opus三个版本。在多项基准测试中超越GPT-4，支持多模态输入，提供更长的上下文窗口。Claude 3代表了对话AI的重大突破。',
      keyPoints: [
        'Claude 3三个版本：Haiku(速度)、Sonnet(平衡)、Opus(性能)',
        '多模态能力：支持图像和文本混合输入',
        '长上下文支持：高达200K token的上下文窗口',
        '基准测试领先：在多项评估中超越GPT-4',
        '安全性提升：减少有害输出和偏见',
        'API可用性：支持开发者集成和定制'
      ],
      importance: 'high',
      publishedAt: '2024-03-04T16:00:00Z',
      originalUrl: 'https://www.anthropic.com/news/claude-3-family',
      tags: ['claude-3', 'haiku', 'sonnet', 'opus', 'multimodal']
    },
    {
      id: '2-prev',
      product: {
  ...
  'claude-code': [
    ...
    },
    {
      ...
      title: 'Claude Code研究预览版发布',
      summary: 'Anthropic发布Claude Code研究预览版，作为命令行AI编程助手，允许开发者从终端直接委派编程任务。基于Claude 4模型，提供强大的代码生成、调试和重构能力，支持多种编程语言和开发工作流。',
      keyPoints: [
        '研究预览版发布：首个终端原生AI编程助手',
        '命令行界面：无需IDE插件，直接在终端使用',
        '任务委派能力：支持复杂编程任务的自主完成',
      ...
      originalUrl: 'https://www.anthropic.com/news/claude-code-preview',
      tags: ['research-preview', 'command-line', 'programming', 'debugging', 'refactoring']
    }
  ],
  'midjourney': [
    {
    ...
    },
    {
      ...
      title: 'Midjourney V6.1性能升级 - 速度与个性化双重提升',
      summary: 'Midjourney发布V6.1版本，图像生成速度提升25%，个性化模型更加精准。新版本在保持V6高质量的基础上，显著改善了处理速度和用户体验。个性化代码版本控制确保项目连续性，为用户提供更稳定的创作环境。',
      keyPoints: [
        'V6.1性能提升：图像生成速度提升25%',
        '个性化模型升级：更好的细节处理和准确性',
        '代码版本控制：确保用户项目的连续性',
        ...
        '用户体验优化：更流畅的创作流程',
        '稳定性改进：减少生成错误和异常',
        '2024年7月30日发布：作为V6系列的最终版本',
        '2025年6月16日结束：V7发布前的最后默认版本'
      ],
      importance: 'high',
      publishedAt: '2024-07-30T14:00:00Z',
      originalUrl: 'https://docs.midjourney.com/hc/en-us/articles/32199405667853-Version',
      tags: ['v6.1', 'performance', 'personalization', 'speed', 'stability', 'user-experience']
    },
    {
      id: '10-prev2',
      product: {
      ...
      title: 'Midjourney V6突破性发布 - 提示精度与图像质量革新',
      summary: 'Midjourney发布V6版本，大幅提升长文本提示的准确性和图像连贯性。新增强的图像提示和混合功能，配合改进的知识库，为用户提供更精确的创作控制。V6标志着Midjourney在AI图像生成领域的重大技术突破。',
      keyPoints: [
        'V6长文本提示：显著提升复杂提示的理解准确性',
        '图像连贯性增强：更好的整体画面统一性',
        '知识库升级：更丰富的艺术和风格理解',
        '高级图像提示：改进的图像到图像生成能力',
        '混合功能增强：更自然的元素融合',
        '2023年12月20日发布：年度重大更新',
        '2024年2月14日：成为默认模型',
        '奠定基础：为V7的突破性改进铺平道路'
      ],
      importance: 'high',
      ...
      originalUrl: 'https://docs.midjourney.com/hc/en-us/articles/32199405667853-Version',
      tags: ['v6', 'text-prompts', 'coherence', 'image-prompting', 'knowledge-base', 'remix']
    },
    {
      id: '10-prev3',
      product: {
      ...
      title: 'Midjourney Web界面全面开放 - 视频生成V1发布',
      summary: 'Midjourney Web界面正式向所有用户开放，无需Discord账户即可使用。同时发布视频生成V1模型，支持图像到视频的动画创作。$10基础订阅用户也可使用视频功能，大幅降低AI内容创作的门槛。',
      keyPoints: [
        'Web界面开放：所有用户无需Discord即可使用',
        '视频生成V1：支持图像到视频动画创作',
        '基础订阅支持：$10订阅用户也可使用视频功能',
        '降低门槛：简化新用户的使用流程',
        '未来规划：文本到视频功能正在开发中',
        '3D渲染预期：V7可能包含3D打印文件生成',
        '移动端优化：Web界面适配移动设备',
        '社区反馈：基于用户需求持续优化界面'
      ],
      importance: 'high',
      ...
      tags: ['web-interface', 'video-generation', 'accessibility', 'no-discord', 'basic-plan', 'mobile']
    }
  ]
}
